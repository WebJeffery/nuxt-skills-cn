...
impact: LOW
impactDescription: 简单的哈希路由缺乏生产 SPA 所需的基本功能；Vue Router 提供导航守卫、懒加载和适当的历史管理
type: best-practice
...
**影响：低** - 虽然你可以使用哈希更改和动态组件实现基本路由，但官方 Vue Router 库应该用于任何生产单页应用。它提供基本功能，如导航守卫、嵌套路由、懒加载和适当的浏览器历史集成，这些功能手动实现既繁琐又容易出错。

## 任务清单

- [ ] 为生产 SPA 安装 Vue Router
- [ ] 仅将简单路由用于学习或微型原型
- [ ] 利用内置功能：守卫、懒加载、meta 字段
- [ ] 考虑基于路由的状态和数据加载模式
