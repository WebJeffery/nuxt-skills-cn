---
name: setting-up
description: 项目设置文件，包括 .gitignore、GitHub Actions 工作流和 VS Code 扩展。用于初始化新项目或添加 CI/编辑器配置时。
---
...
**`.github/workflows/unit-test.yml`** - 在 push/PR 上运行测试：
...
**`.github/workflows/release.yml`** - 在标签上发布（仅限库项目）：
...
| `antfu.pnpm-catalog-lens` | 在线显示 pnpm 目录版本提示 |
